...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // Get UI elements
        val timeText = findViewById<EditText>(R.id.timeline)
        val mealText = findViewById<TextView>(R.id.foodText)
        val resetButton = findViewById<Button>(R.id.ResetButton)
        val submitButton = findViewById<Button>(R.id.respondButton)
